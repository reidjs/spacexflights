...
const Controls = __webpack_require__(5);
const PayloadChart = __webpack_require__(6);
const Store = __webpack_require__(20);
const Slider = __webpack_require__(21);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  store.setLaunches().then(launchData => {
    ...
    store.setLaunchPads().then(launchPadData => {
      myApp = new App(launchData.launches, launchPadData);
      myApp.update(0)
    })
  })
...
const Chart = __webpack_require__(7)
...
const Globe = __webpack_require__(2);
...
class App {
  ...
  update(missionNumber) {
    let thisLaunch = this.launchData[missionNumber];
    ...
    map.setStreetView(panorama);
    this.globe.render([0, 0], 0.01, -0.03, 1.2, 1, -140, 0);
