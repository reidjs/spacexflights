...
const PayloadChart = __webpack_require__(2);
...
const Chart = __webpack_require__(3)
...
const Globe = __webpack_require__(6);
...
class App {
  ...
  update(missionNumber) {
    ...
    if (thisLaunch.launch_success) {
      ...
      $("div.details > h2 > span.fail").addClass("hide");
    } else {
      // $("div.details h2").removeClass("success");
      $("div.details > h2 > span.fail").removeClass("hide");
    }
...
class Globe {
    constructor() {
        ...
        this.orbits = {
                "LEO": {
                    p0: {x: width/2 - radius*2, y: height/2},
                    p1: {x: width/2+radius+30, y: height/2},
                    p2: {x:  width/2 + radius+70, y: height/2},
                    p3: {x: width / 2-radius*2, y: height/2}
                },
                "SSO": {
                    p0: {x: width/2-radius, y: height/2+1.5*radius},
                    p1: {x: width/2+33, y: -33},
                    p2: {x:  width/2+33 , y: -33},
                    p3: {x: width/2-radius, y: height/2+1.5*radius }
                },
                "ISS": {
                ...
                "GTO": {
                    p0: {x: width/2 - radius*2, y: height/2 + radius/2},
                    p1: {x: width+30, y: height/2},
                    p2: {x: width+30, y: height/2 - radius},
                    p3: {x: width / 2-radius*2, y: height/2+radius/2 }
                },
                "Polar": {
                    p0: {x: width/2-50, y: height+20},
                    p1: {x: width/2-50, y: -50},
                    p2: {x:  width/2-50 , y: -50},
                    p3: {x: width/2-50, y: height+20 }
                },
                "ES-L1": {
                    p0: {x:  width/2 + radius , y: height/2 - radius},
                    p1: {x:  width/2 + radius -20, y: height/2 - 10},
                    p2: {x:  width/2 + radius +50, y: height/2 - 40},
                    p3: {x:  width/2 + radius +150 , y: height/2 - radius}
                }
    ...
    render(orbit, launchSite) {
        ...
        let thisOrbit = this.orbits[orbit] //this should be [orbit]
        ...
        d3.json("https://raw.githubusercontent.com/d3/d3.github.com/master/world-110m.v1.json", (error, world) => {
            ...
            let currentXAngle = 0.01*elapsed % 360;
