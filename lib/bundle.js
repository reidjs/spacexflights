...
const Flight = __webpack_require__(3);
const ViewFlight = __webpack_require__(7);

const Timeline = __webpack_require__(8);
const ViewTimeline = __webpack_require__(11);
...
class Controller {
  constructor() {
    ...
    this.ctx = canvasEl.getContext("2d"); //flight sim
    this.ctx2 = canvasEl.getContext("2d"); //time line
...
const Launch = __webpack_require__(9);
...
const TimelineObject = __webpack_require__(10);
